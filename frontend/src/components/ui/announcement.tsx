...
export const Announcement = ({
  ...
  <BadgeContext.Provider value={{ themed }}>
    <Badge
      variant={variant}
      className={cn(
        "max-w-full gap-2 rounded-full bg-card px-3 py-1 font-medium shadow-sm transition-all hover:shadow-md",
...
export const AnnouncementTitle = ({ className, ...props }: AnnouncementTitleProps) => (
  <div className={cn("flex min-w-0 items-center gap-2 truncate py-1", className)} {...props} />
);
